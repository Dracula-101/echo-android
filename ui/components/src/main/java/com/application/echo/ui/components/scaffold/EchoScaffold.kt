package com.application.echo.ui.components.scaffold
...
import com.application.echo.ui.components.navigation.EchoBottomAppBar
import com.application.echo.ui.components.navigation.EchoNavigationRail
import com.application.echo.ui.components.scaffold.model.EchoPullToRefreshState
import com.application.echo.ui.components.scaffold.model.ScaffoldNavigationData
import com.application.echo.ui.components.scaffold.model.rememberEchoPullToRefreshState
import com.application.echo.ui.components.scrim.EchoAnimatedScrim
...
fun EchoScaffold(
    ...
    pullToRefreshState: EchoPullToRefreshState = rememberEchoPullToRefreshState(),
    containerColor: Color = EchoTheme.colorScheme.background.color,
    contentColor: Color = EchoTheme.colorScheme.background.onColor,
                    ...
                    Column {
                        ...
                        Box(
                            ...
                            PullToRefreshDefaults.Indicator(
                                ...
                                isRefreshing = pullToRefreshState.isRefreshing,
                                state = internalPullToRefreshState,
                                containerColor = EchoTheme.colorScheme.primary.container,
